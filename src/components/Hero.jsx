  ...
  return (
    <div className="bg-blue-600 text-white py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-lg md:text-xl mb-4">Share your complete business profile and customize your card's theme to match your brand</p>
        <p className="text-md mb-8">A product of Ad Web Comic Agency - Innovating digital solutions</p>
